...
/**
 * Chrome for the superadmin console. Split out of app/platform/layout.tsx so
 * that layout can be a server component and check `isSuperadmin` before any of
 * this renders — the active-link highlight needs `usePathname`, which is the only
 * reason this half is a client component.
 *
 * Deliberately not localized: /platform is operator-only, English by design (see
 * the i18n section in CLAUDE.md).
 */
const NAV = [
